...
if("TRUE" STREQUAL "TRUE")
  set(coverage_path_planner_SOURCE_PREFIX /home/penghui/pioneer_ws/src/coverage_path_planner)
  set(coverage_path_planner_DEVEL_PREFIX /home/penghui/pioneer_ws/devel)
  ...
  set(coverage_path_planner_INSTALL_PREFIX /home/penghui/pioneer_ws/install)
...
if(NOT "/home/penghui/pioneer_ws/devel/include;/home/penghui/pioneer_ws/src/coverage_path_planner/include " STREQUAL " ")
  set(coverage_path_planner_INCLUDE_DIRS "")
  set(_include_dirs "/home/penghui/pioneer_ws/devel/include;/home/penghui/pioneer_ws/src/coverage_path_planner/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'xx <xx@163.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'coverage_path_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/penghui/pioneer_ws/src/coverage_path_planner/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND coverage_path_planner_EXPORTED_TARGETS ${${coverage_path_planner_dep}_EXPORTED_TARGETS})
endforeach()
