...
get_filename_component(_filename "/home/penghui/pioneer_ws/src/coverage_path_planner/srv/GetPathInZone.srv" NAME_WE)
add_custom_target(_coverage_path_planner_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "coverage_path_planner" "/home/penghui/pioneer_ws/src/coverage_path_planner/srv/GetPathInZone.srv" "nav_msgs/Path:geometry_msgs/Pose:std_msgs/Header:geometry_msgs/Point:geometry_msgs/PoseStamped:geometry_msgs/Quaternion"
)
...
_generate_srv_cpp(coverage_path_planner
  "/home/penghui/pioneer_ws/src/coverage_path_planner/srv/GetPathInZone.srv"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/coverage_path_planner)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/coverage_path_planner\")")
  # install generated code
  install(
