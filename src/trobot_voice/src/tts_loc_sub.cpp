...
if ( wakeupFlag>2){
	//先把接收到的字符串打印出来
    std::cout<<"I heard :"<<"在"<<msg->data.c_str()<<"发现人脸特征"<<std::endl;

    text1= msg->data.c_str(); 	//把传入的字符串赋值给将要生成语音的text
    text2="发现人脸特征";
...
int main(int argc, char* argv[])
{
    ...
    */
    ros::Subscriber sub1 =n.subscribe("voiceWords", 1,wakeupCallback);
    ros::Subscriber sub2 =n.subscribe("loc", 1, voiceWordsCallback);
    ros::spin();
